...
const MainLanding = () => {
  return (
    <>
      ...
      <section className="flex flex-col items-center pt-11 px-[70px] pb-[170px] max-1024:pt-7 max-1024:pb-14 max-1024:px-4">
        ...
        <ClientCards className='mt-14 max-1024:mt-8' />
      </section>
    </>
  );
};
