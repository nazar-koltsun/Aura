  ...
  return (
    <section className="relative px-10 pt-14 pb-24 max-1024:pt-14 max-1024:pb-[75px] max-1024:px-4">
      <div className="relative z-10 max-w-[60vw] ml-auto flex flex-col justify-center items-center max-700:max-w-full max-700:ml-0">
        ...
        <p className="mt-5 max-w-[500px] text-[18px] leading-[30px] text-center text-white font-medium max-1024:max-w-[400px]">
          Odkryj, jak prosty język buduje przyjazny urząd.
        </p>

        <Button
          path={'#'}
          className="inline-flex min-w-[250px] mt-7 py-4 px-9 text-[17px] bg-[var(--sandy-brown)] hover:bg-[#DE8640] max-1024:mt-4 max-1024:min-w-[220px]"
        >
          Rozpocznij naukę
        </Button>
      </div>
