...
const plansData = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Lider, któremu zaufają!',
        icon: <MindsetThinkingGreenIcon />,
        features: [
          'Udzielanie inspirującego feedbacku',
          'Motywowanie poprzez wartości',
          'Skuteczna komunikacja oczekiwań',
          'Rozumienie potrzeb zespołu',
          'Zarządzanie obawami i wyzwaniami',
        ],
      }
    ],
    color: '#2A9D8F',
