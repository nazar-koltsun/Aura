...
const MainSection = () => {
  return (
    <section className="relative px-10 pt-10 pb-24 max-1024:pt-14 max-1024:pb-[75px] max-1024:px-4">
      <div className="relative z-10 max-w-[50vw] ml-auto flex flex-col justify-center items-center max-700:max-w-full max-700:ml-0">
        ...
        <p className="mt-8 max-w-[500px] text-[18px] leading-[30px] text-center text-white font-medium max-1024:mt-6 max-1024:max-w-[400px]">
