...
const WhatDoYouGetSection = ({ benefits, isBannerLarge, isCarouselOnMobile, className }) => {
  return (
    <section className={cn("relative px-4", className)}>
      ...
      <div className='pt-7 pb-10 flex flex-col justify-center items-center max-w-[950px] mx-auto'>
        ...
        <Benefits className='mt-8 max-1024:mt-8' benefits={benefits} isBannerLarge={isBannerLarge} isCarouselOnMobile={isCarouselOnMobile} />
