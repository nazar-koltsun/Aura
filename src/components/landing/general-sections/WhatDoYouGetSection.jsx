  ...
  return (
    <section className="relative -mt-4 px-4">
      ...
      <div className='py-6 flex flex-col justify-center items-center max-w-[950px] mx-auto'>
        ...
        <Benefits className='mt-14' benefits={benefits} />
        ...
        <div className='mt-14 flex justify-center items-center gap-6'>
          ...
          <Button path='#' variant='bordered' className='text-[17px] min-w-[262px] min-h-[60px] border-2 tracking-wider'>Zobacz wideo</Button>
        </div>
      </div>
    </section>
  );
