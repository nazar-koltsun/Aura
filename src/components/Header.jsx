...
const Header = ({ navItems = [], className }) => {
  return (
    <header className={cn("col-span-2 flex justify-between items-center gap-6 px-14 py-2.5 border-b border-[var(--bright-gray)] max-1024:px-6 max-1024:gap-4 bg-white z-20", className)}>
